...
let namearr:string []  = ["Bilal", "Nabeel", "Akmal"];
...
let gusetArry : string [] = ["Nouman","Munzir","Bilal"]

let canNotAttend:string ="Nouman";
let newGuests:string = "Nabeel"
gusetArry[gusetArry.indexOf(canNotAttend)] = newGuests;
gusetArry.map((items)=>{
console.log(`Dear ${items} , You are invited to the dinner.`);

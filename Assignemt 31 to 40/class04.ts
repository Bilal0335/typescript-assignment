...
let user_Names: string[] = ["admin", "bilal", "john", "charlie", "david"];
...
//! Q32.Checking Usernames: Do the following to create a program that simulates how websites ensure that ev!eryone has a unique username.
...
make_shirts("medium", "i need a big shirt.")
...
// Function to return a string formatted as "City, Country"
function city_country(city: string, country: string): string {
    return `${city}, ${country}`;
}

// Calling city_country() function with three city-country pairs
